...
from src.components.data_trasnformation import DataTransformationConfig
...
if __name__ =="__main__":
    ...
    train_array,test_array,_ = data_transformation.initiate_data_transformer(train_data,test_data)
